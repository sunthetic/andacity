...
export const formatItineraryDateTime = (
...
export const formatItineraryDateRange = (
  ...
  if (!start) return formatItineraryDateTime(endAt, options);
  if (!end) return formatItineraryDateTime(startAt, options);
