      ...
      <div class="grid gap-5 lg:grid-cols-[1fr_360px] lg:items-start">
        <div>
          ...
          <p class="mt-2 max-w-[80ch] text-sm text-[color:var(--color-text-muted)] lg:text-base">
            Clean city guide for {c.city}. Transparent totals, clear policies,
            and fast filtering — without indexing SERPs.
          </p>
        ...
        >
          <HotelCitySearchCard
            ...
            adults={
              data.active.adults != null ? String(data.active.adults) : ""
            }
      ...
      <section class="mt-8 t-card p-5">
        ...
        <div class="prose prose-sm mt-3 max-w-none text-[color:var(--color-text)]">
          <p class="text-[color:var(--color-text-muted)]">
            This section is your long-tail SEO payload: best areas, pricing
            seasonality, airport access, transit, and what matters to different
            traveler types.
          </p>
