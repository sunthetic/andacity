...
const buildErrorState = (
  ...
  if (page.kind === "invalid_route") {
    return {
      ...
      description:
        "Entity detail rendering only works from canonical car routes generated by the shared TASK-025 routing utilities.",
      primaryAction: {
        label: "Back to car search",
        href: getBookableEntitySearchHref("car"),
      },
...
const buildBreadcrumbs = (page: BookableEntityPageLoadResult) => {
  ...
  return [
    ...
    { label: "Entity", href: getBookableEntityRouteBase("car") },
    {
      label:
        page.kind === "resolved"
