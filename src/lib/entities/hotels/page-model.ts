  ...
  note:
    page.kind === "revalidation_required"
      ...
      : page.kind === "unavailable"
        ...
        : "Adds this stay to a persisted trip and opens the updated trip page.",
...
const buildErrorState = (
  ...
  if (page.kind === "invalid_route") {
    return {
      ...
      description:
        "Entity detail rendering only works from canonical hotel routes generated by the shared routing utilities.",
      primaryAction: {
        label: "Back to hotel search",
        href: getBookableEntitySearchHref("hotel"),
      },
...
const buildBreadcrumbs = (page: BookableEntityPageLoadResult) => {
  ...
  return [
    ...
    { label: "Search", href: getBookableEntitySearchHref("hotel") },
    {
      label:
        page.kind === "resolved"
