...
export const ResultsPagination = component$((props: ResultsPaginationProps) => {
  ...
  return (
    <nav class="mt-6 flex flex-wrap items-center justify-between gap-3" aria-label="Results pages">
      ...
      <div class="flex flex-wrap items-center gap-2">
        {props.prevHref ? (
          <a
            class="rounded-full border border-[color:var(--color-border-default)] bg-[color:var(--color-surface-elevated)] px-3 py-1.5 text-xs font-medium text-[color:var(--color-text)] transition hover:bg-white"
            href={props.prevHref}
            rel="prev"
          >
            Previous
