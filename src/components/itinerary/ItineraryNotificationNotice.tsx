...
const getToneClasses = (
  tone: NonNullable<ItineraryPageModel["notificationNotice"]>["tone"],
) => {
  if (tone === "success") {
...
export const ItineraryNotificationNotice = component$(
  (props: {
    notice: ItineraryPageModel["notificationNotice"];
  }) => {
