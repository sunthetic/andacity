...
import type { FlightResultsErrorStateModel } from "~/types/search-ui";

export const FlightResultsErrorState = component$((props: FlightResultsErrorStateProps) => {
  return (
    <section
...
type FlightResultsErrorStateProps = {
  model: FlightResultsErrorStateModel;
};
