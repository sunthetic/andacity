  ...
  return (
    <section class="mt-4 t-panel p-3 md:p-4">
      <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div class="flex items-center gap-2 text-sm font-medium text-[color:var(--color-text)]">
        ...
        <div class="flex flex-wrap items-center gap-2">
          {props.onToggleFilters$ ? (
            <button
              class="t-btn-primary lg:hidden disabled:cursor-not-allowed disabled:opacity-60"
              type="button"
