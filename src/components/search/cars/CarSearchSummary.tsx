...
import type { CarSearchSummaryModel } from "~/types/search-ui";

export const CarSearchSummary = component$((props: CarSearchSummaryProps) => {
  return (
          ...
          <dl class="mt-4 grid gap-3 text-sm text-[color:var(--color-text-muted)] sm:grid-cols-2 xl:grid-cols-4">
            <div class="rounded-2xl bg-[color:var(--color-neutral-50)] px-4 py-3">
              ...
              <dd class="mt-1 font-semibold text-[color:var(--color-text-strong)]">
                {props.summary.pickupCode}
              </dd>
              <p class="mt-1 text-xs text-[color:var(--color-text-muted)]">
                {props.summary.pickupDateLabel}
              </p>
            </div>
            ...
            <div class="rounded-2xl bg-[color:var(--color-neutral-50)] px-4 py-3">
              ...
              <dd class="mt-1 font-semibold text-[color:var(--color-text-strong)]">
                {props.summary.dropoffCode}
              </dd>
              <p class="mt-1 text-xs text-[color:var(--color-text-muted)]">
                {props.summary.dropoffDateLabel}
              </p>
            </div>
