...
export const GlobalSearchEntry = component$((props: GlobalSearchEntryProps) => {
  ...
  return (
    <div id={props.id} class={["relative z-20", props.class]}>
      <BookingSearchSurface class="border-[color:var(--color-border)] p-4 shadow-[var(--shadow-xl)] backdrop-blur md:p-5">
        <div class="flex flex-col gap-4">
          <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            ...
            <div
              ...
              class="relative z-10 inline-flex w-full flex-wrap gap-2 rounded-[var(--radius-xl)] bg-[color:var(--color-surface-muted)] p-1 shadow-[inset_0_1px_2px_rgba(15,23,42,0.08)] lg:w-auto lg:flex-nowrap"
            >
                ...
                return (
                  <button
                    ...
                    class={[
                      ...
                      isActive
                        ? "bg-[image:var(--grad-primary)] text-white shadow-[var(--shadow-md)]"
                        : "text-[color:var(--color-text-muted)] hover:bg-[color:var(--color-surface-1)] hover:text-[color:var(--color-text-strong)]",
                    ]}
                    onClick$={() => {
          ...
          <div
            ...
            class="relative z-20 rounded-[var(--radius-xl)] bg-[color:var(--color-surface-1)] p-3 shadow-[inset_4px_0_0_var(--color-route),var(--shadow-sm)] md:p-4"
          >
