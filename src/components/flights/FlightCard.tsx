  ...
  return (
    <article class="t-card p-4">
      <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div class="text-sm font-semibold text-[color:var(--color-text-strong)]">{flight.airline}</div>
          ...
          <div class="mt-3 flex flex-wrap gap-2">
            ...
            {flight.cabinClass ? <span class="t-badge">{formatCabinClass(flight.cabinClass)}</span> : null}
          </div>
        </div>
        ...
        <div class="text-right">
          <p class="text-sm font-semibold text-[color:var(--color-text-strong)]">
            ...
            <span class="ml-1 text-xs font-normal text-[color:var(--color-text-muted)]">/traveler</span>
          </p>

          <div class="mt-4">
            <a class="t-btn-primary inline-block px-4 py-2 text-sm" href={props.ctaHref || '/flights'}>
              Select flight
            </a>
          </div>
        </div>
