...
import type { FlightEntityErrorStateModel } from "~/types/flight-entity-page";

export const FlightEntityErrorState = component$(
  (props: FlightEntityErrorStateProps) => {
    return (
...
type FlightEntityErrorStateProps = {
  state: FlightEntityErrorStateModel;
};
