...
import type { HotelEntityErrorStateModel } from "~/types/hotel-entity-page";

export const HotelEntityErrorState = component$(
  (props: HotelEntityErrorStateProps) => {
    return (
...
type HotelEntityErrorStateProps = {
  state: HotelEntityErrorStateModel;
};
